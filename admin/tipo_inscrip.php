...
<html lang="en">
 ...
 <?php
	...
	$miconexion->consulta("select * from tipo_inscritos");
	$miconexion->verconsulta5();
	if($act==1){
		$miconexion->consulta("delete from tipo_inscritos where id_tipo=$id");
		$miconexion->verconsulta5();
	...
	if($act==3){
		...
		echo '<script>alert("Ingresar")</script>';
      	echo "<script>location.href='ingresar_tipo.php'</script>";
	}
?>
</div>
</div>
